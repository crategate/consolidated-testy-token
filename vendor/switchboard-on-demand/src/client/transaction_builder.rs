...
impl TransactionBuilder {
    ...
    pub fn build_v0_tx(
        ...
        let converted_lookup_accounts: Vec<crate::solana_compat::solana_sdk::message::AddressLookupTableAccount> = address_lookup_accounts.iter().map(|lut| {
            crate::solana_compat::solana_sdk::message::AddressLookupTableAccount {
